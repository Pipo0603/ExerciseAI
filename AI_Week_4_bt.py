...
rule21=ctrl.Rule(time['veryslow']&rice['veryless'],power['low'])
rule22=ctrl.Rule(time['veryslow']&rice['less'],power['balance'])
rule23=ctrl.Rule(time['veryslow']&rice['medium'],power['high'])
rule24=ctrl.Rule(time['veryslow']&rice['much'],power['high'])
rule25=ctrl.Rule(time['veryslow']&rice['verymuch'],power['high'])
tipping_ctrl = ctrl.ControlSystem([rule1,rule2,rule3,rule4,rule5,rule6,rule7,rule8,rule9,rule10,rule11,rule12,rule13,rule14,rule15,rule16,rule17,rule18,rule19,rule20,rule21,rule22,rule23,rule23,rule24,rule25])
tipping = ctrl.ControlSystemSimulation(tipping_ctrl)
tipping.input['time']=30
tipping.input['rice']=450
tipping.compute()
